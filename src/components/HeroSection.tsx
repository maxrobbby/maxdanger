      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <p 
              className="text-primary font-display text-sm md:text-base tracking-[0.3em] mb-4 opacity-0 animate-fade-up"
              style={{ animationDelay: "0.2s" }}
            >
              Massimiliano Roberto presenta
            </p>
            ...
            >
              Un thriller action mozzafiato che ti terrà incollato alle pagine fino all'ultima riga.
            </p>
            ...
            >
              <div className="text-center">
                <p className="text-2xl font-display text-primary">2025</p>
                <p className="text-xs uppercase tracking-wider">In uscita</p>
              </div>
